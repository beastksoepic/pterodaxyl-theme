...
const StyledField = styled(Field)`
    ...
    &:active {
        box-shadow: 0 0 0 0.25rem #fd65005e !important;
    }
...
export default ({ className }: WithClassname) => {
    ...
    return (
        <>
                    ...
                    >
                        ...
                        <Form css={tw`m-0`}>
                            ...
                            >
                                ...
                                &nbsp;/container/{join(directory, values.directoryName).replace(/^(\.\.\/|\/)+/, '')}
                            </p>
                            <div css={tw`flex justify-end`}>
                                <Button css={tw`mt-8`} color={'primary'}>
                                    Create Directory
                                </Button>
                            </div>
                        </Form>
            ...
            <Button isSecondary color={'primary'} onClick={() => setVisible(true)} className={className}
                size={'xsmall'}
            >
                Create Directory
            </Button>
