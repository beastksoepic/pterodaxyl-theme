...
const FileObjectRow = ({ file, index, length }: { file: FileObject, index: number, length: number }) => (
    <Row
        key={file.name}
        onContextMenu={e => {
            e.preventDefault();
        ...
        style={{
            ...
            borderBottomLeftRadius: index === (length - 1) ? '5px' : '0',
            borderBottomRightRadius: index === (length - 1) ? '5px' : '0',
        }}
    >
