                ...
                <Modal {...props}>
                    <Form>
                        <FormikFieldWrapper
                            ...
                            description={'To start searching enter a server name, uuid, or allocation.'}
                        >
                            <SearchWatcher/>
                            <InputSpinner visible={isSubmitting}>
                                <StyledField as={InputWithRef} name={'term'}/>
                            </InputSpinner>
                        </FormikFieldWrapper>
                    </Form>
                    {servers.length > 0 &&
                            ...
                            servers.map(server => (
                                ...
                                >
                                    ...
                                    <div css={tw`flex-none text-right`}>
                                        <span css={tw`text-xs py-1 px-2 bg-cyan-800 rounded`}
                                            style={{
