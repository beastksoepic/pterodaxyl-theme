                    ...
                    <CSSTransition timeout={150} classNames={'fade'} appear in>
                        <SubNavigation>
                            <div>
                                ...
                                <Can action={'file.*'}>
                                    <NavLink to={`${match.url}/files`}>File Explorer</NavLink>
                                </Can>
                                <Can action={'database.*'}>
                                ...
                                <Can action={'user.*'}>
                                    <NavLink to={`${match.url}/subusers`}>Subusers</NavLink>
                                </Can>
                                <Can action={'backup.*'}>
                                ...
                                <Can action={'startup.*'}>
                                    <NavLink to={`${match.url}/variables`}>Variables</NavLink>
                                </Can>
                                <Can action={[ 'settings.*', 'file.sftp' ]} matchAny>
                                    <NavLink to={`${match.url}/information`}>Information</NavLink>
                                </Can>
                                {rootAdmin &&
                        ...
                        <ErrorBoundary>
                            <TransitionRouter>
                                <Switch location={location}>
                                    ...
                                    <Route path={`${match.path}/subusers`} exact>
                                    ...
                                    <Route path={`${match.path}/variables`} component={StartupContainer} exact/>
                                    <Route path={`${match.path}/information`} component={SettingsContainer} exact/>
